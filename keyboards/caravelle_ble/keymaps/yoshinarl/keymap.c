...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //|--------+--------+--------+--------+--------+------------------+----------------+      +--------+------------------+--------+--------+--------+------------------+--------|
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,              KC_MINS,                KC_EQL,  KC_H,              KC_J,    KC_K,    KC_L,    LT(RAISE,KC_SCLN), KC_QUOT, \
 //|--------+--------+--------+--------+--------+------------------+----------------|      |--------+------------------+--------+--------+--------+------------------+--------|
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,              LT(ADJUST,KC_GRV),      KC_BSPC, KC_N,              KC_M,    KC_COMM, KC_DOT,  KC_SLSH,           KC_RSFT, \
 //|--------+--------+--------+--------+--------+------------------+----------------|      |--------+------------------+--------+--------+--------+------------------+--------|
                               KC_RALT, KC_LGUI, LT(LOWER,KC_LNG1), KC_SPC,                 KC_ENT,  LT(RAISE,KC_LNG2), KC_LBRC, KC_RBRC \
 //                           +--------+--------+------------------+--------+              +--------+------------------+--------+--------+
  ),
 ...
 //|--------+--------+--------+--------+--------+--------+--------+      +--------+--------+--------+--------+--------+--------+--------|
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,        _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_F12,  \
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
 ...
 //                           +--------+--------+--------+--------+      +--------+--------+--------+--------+
  ...
  [_RAISE] = LAYOUT(
 //+--------+--------+--------+--------+--------+--------+                        +--------+--------+--------+--------+--------+--------+
    KC_ESC,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                          KC_HOME, KC_PGUP, KC_UP,   KC_PGDN, XXXXXXX, XXXXXXX, \
 //|--------+--------+--------+--------+--------+--------+--------+      +--------+--------+--------+--------+--------+--------+--------|
    _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______,        _______, KC_END,  KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, \
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
